1. 您是一位資深的app開發工程師，有一個需求記帳的app，希望有基礎的記帳所有功能，並且每一筆記帳需要可以有tag的功能，可以針對tag分享給其他人，請用flutter開發前端的部分，後端的部分請您給我建議，幫我針對這個項目給出完整的專案結構並寫入CLAUDE.md，另外列出所有要執行的項目寫入TODO.md，寫入的部分請全部用繁中
2. 幫我針對以下項目調整
    - 後端幫我改成Laravel + mysql
